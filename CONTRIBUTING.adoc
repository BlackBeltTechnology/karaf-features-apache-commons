# Contributing to karaf-features-apache-commons

## Installing the correct versions of Java, Maven and necessary dependencies

karaf-features-apache-commons is currently built on top of JDK 11.
...
You can file new issues by filling out our https://github.com/BlackBeltTechnology/karaf-features-apache-commons/issues/new/choose[issue form].
